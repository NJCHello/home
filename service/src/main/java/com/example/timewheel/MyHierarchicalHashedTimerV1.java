...
public class MyHierarchicalHashedTimerV1 implements Timer {
    ...
    private final class Worker implements Runnable{
            ...
            while (true){
                ...
                MyHierarchicalHashedTimerV1.this.lowestTimeWheel.advanceClockByTick(
                        (taskNode)->
                                ...
                                MyHierarchicalHashedTimerV1.this.lowestTimeWheel.addTimeoutTask(MyHierarchicalHashedTimerV1.this.startTime, taskNode)
                );
        ...
        private void waitForNextTick(){
            ...
            long nextTickTime = (MyHierarchicalHashedTimerV1.this.totalTick + 1) * MyHierarchicalHashedTimerV1.this.perTickTime + MyHierarchicalHashedTimerV1.this.startTime;
